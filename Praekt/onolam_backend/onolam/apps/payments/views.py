...
def create_payment(request):
    ...
    # Demo rejim — PayMe/Click hali ulanmagan
    ...
    # Payment ni muvaffaqiyatli deb belgilash
    ...
    return Response({
        ...
        'amount':     float(amount),
        'demo':       True,
        'message':    'Pro tarif faollashtirildi! 30 kun davomida barcha imkoniyatlar ochiq.',
        'success':    True,
    })
