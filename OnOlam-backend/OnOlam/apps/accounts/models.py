...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    last_activity   = models.DateField(null=True, blank=True, verbose_name='Oxirgi faollik')
    ...
    def update_streak(self):
        ...
        if self.last_activity == today:
            return  # Bugun allaqachon hisoblanad

        if self.last_activity and (today - self.last_activity).days == 1:
