...
class LessonListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_minutes', 'is_published', 'is_accessible',
        ]
...
class LessonDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_published', 'is_accessible', 'quiz',
        ]
    ...
    def to_representation(self, instance):
        ...
        # Pro kontent — foydalanuvchi pro bo'lmasa yashirish
...
class CourseDetailSerializer(CourseListSerializer):
    ...
    class Meta(CourseListSerializer.Meta):
        fields = CourseListSerializer.Meta.fields + ['description', 'lessons', 'tags', 'tags_list', 'language']
